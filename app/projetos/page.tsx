...
const allProjects = [
  ...
  },
  {
    ...
    category: 'Estetica',
    description:
      'para o julio passa as informações ainda',
    tags: ['Java', 'JavaScript', 'Spring Boot', 'SQL', 'Node.js'],
  ...
  },
  {
    ...
    category: 'Telecom',
    description:
      'Em inicio ainda sem mais informações',
    tags: ['React Native', 'Expo', 'supraBase', 'Nest.js', 'TypeScript', 'OpenAI'],
